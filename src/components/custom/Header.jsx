  ...
  const getUserProfile = (tokenInfo) => {
    ...
    return (
      <div className='p-2 shadow-sm flex justify-between align-top'>
        <img src="/logo.svg" className='ml-2 md:ml-4' alt="logo" />
        {user ?
          <div className='flex flex-row justify-center gap-2 md:mr-4'>
            <a href="/my-trips">
            ...
            }} className='rounded-full h-8 cursor-pointer md:mr-4' alt="" />
            {openPopUp &&
              <ProfileCard user={user} setPopUp={setPopUp} />
              }
          </div> :
          <Button className='mr-6' onClick={()=>setOpenDialog(true)}>Sign In</Button>
        }
